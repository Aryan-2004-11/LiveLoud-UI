...
const sections = ["Posts", "friends", "Following"];
...
const Profile: React.FC = () => {
  ...
  return (
    <div className={s.root} style={{ overflow: "disabled" }}>
      {avatarUploadMode && (
        <UploadAvatarModal setAvatarUploadMode={setAvatarUploadMode} />
      )}
      <div className={s.container}>
        ...
        <div className={s.posts}>
          {sections[sectionIndex].toLowerCase() === "friends" ? (
            <h2>{userData?.firstName}'s followers</h2>
          ) : (
            <h2>
